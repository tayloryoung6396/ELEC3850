...
public:
    ...
    static double w_Goal_Position[2];   //wrt front of tank and the world
    static double gens_sonics[SENSORS]; //this variable will need to be names and connected up with gens sonics
